...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void _handleSplashLogic() async {
    await SharedPreferencesHelper.setFirstLaunch(false);

    // Delay for 2 seconds (show splash screen)
    ...
    if (!isFirstLaunch) {
      ...
      // Set isFirstLaunch to false and navigate to SplashScreen
    } else {
      // Check if the user is logged in based on the presence of apiToken
      ...
      if (isLoggedIn) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            content: Text('User logedOut Please Login'),
                        ...
                        ? AnimatedOpacity(
                            ...
                            child: CommonButton(
                              padding: const EdgeInsets.only(
                                  left: 48, right: 48, bottom: 38, top: 8),
