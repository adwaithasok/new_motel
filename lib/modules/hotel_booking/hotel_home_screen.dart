...
class _HotelHomeScreenState extends State<HotelHomeScreen>
  ...
  @override
  void initState() {
    Provider.of<SearchVillaProvider>(context, listen: false).fetchVillas();
  ...
  Widget build(BuildContext context) {
    ...
    var villaProvider = Provider.of<SearchVillaProvider>(context);
